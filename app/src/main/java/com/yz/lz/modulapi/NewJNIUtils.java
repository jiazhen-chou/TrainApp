...
public class NewJNIUtils implements RfidClient{
    public int fdcontext = 0;
    static {
        System.loadLibrary("rfidnew-lib");
    }


    private static NewJNIUtils instance = null;
     ...
     * @return JINUtils 对象
     */
    public static NewJNIUtils getInstance() {
        if (instance == null) {
            instance = new NewJNIUtils();
        }
        return instance;
    }
