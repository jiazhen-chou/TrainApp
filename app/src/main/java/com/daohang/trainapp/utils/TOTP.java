...
public class TOTP {
    ...
    public static String generateMyTOTP() {
        ...
        try {
            ...
            long time2=sdf.parse(day).getTime();
            System.out.println(String.format("time1: %s time2:%s", time1,time2));
            //long now = new Date().getDate();
            time = Long.toHexString(timeFactor(time2)).toUpperCase();
     ...
     * @return boolean
     */
    public static boolean verifyTOTPRigidity( String totp) {
